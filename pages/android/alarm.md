...
- tempo trascorso (**Elapset Real Time - ERT**).
...
- con Alarm RTC, si avrebbe un enorme numero di richieste contemporanee al server e conseguenti problemi nel caso in cui si opti di svegliare il dispositivo: tutti i dispositivi verrebbero svegliati nello stesso momento (1).
- ERT senza wake up (2) è la più vantaggiosa, perché possiede due elementi di randomizzazione, che ci rendono sicuri del fatto che le richieste di aggiornamento avverranno in intervalli differernti:
